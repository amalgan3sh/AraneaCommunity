                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 <div class="d-flex align-items-center">
                                    ...
                                    <form class="post-text ms-3 w-100" method="post" action="<?= base_url('post/create_post') ?>">
                                        <input type="text" name="content" class="form-control rounded" placeholder="Write something here..." style="border:none;" required>
