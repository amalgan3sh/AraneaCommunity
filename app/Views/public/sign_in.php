...
<section class="sign-in-page">
   <div class="container-fluid">
      <div class="row align-items-center">
         ...
         <div class="col-md-6">
            <div class="sign-in-from text-center">
               ...
               <form class="mt-5" method="post" action="<?= base_url('login_user') ?>">
    <div class="form-group text-start">
        <h6 class="form-label fw-bold">Username or Email Address</h6>
        <input type="text" name="email" class="form-control mb-0" placeholder="Your Username or Email" required>
    </div>
    <div class="form-group text-start">
    ...
    <h6 class="mt-5">Don't Have An Account? <a href="sign_up">Sign Up</a></h6>
</form>
