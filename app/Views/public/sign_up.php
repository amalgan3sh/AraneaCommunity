...
<html lang="en" class="theme-fs-md">
  ...
  <body class="">
    ...
    <style>
    body {
        background-color: #ffffff; /* Set this to your desired background color */
    }
</style>
    <!-- loader END -->
...
<section class="sign-in-page">
   <div class="container-fluid">
               ...
               <div class="swiper swiper-general overflow-hidden " data-slide="1" data-laptop="1" data-tab="1" data-mobile="1"
                  ...
                  <ul  class="swiper-wrapper list-inline m-0 p-0 ">
                     <li class="swiper-slide">
                        <img src="../assets/images/public_login.jpg" class="signin-img img-fluid mb-5 rounded-3" alt="image">
         ...
         <div class="col-md-6">
            <div class="sign-in-from text-center">
               <a href="../index.html"
                  ...
                  <h2 class="logo-title" data-setting="app_name">Aranea Community</h2>
               </a>
               <p class="mt-3 font-size-16">Welcome to Aranea Community, a platform to connect with<br/> the social world</p>
               <form class="mt-5" method="post" action="<?= base_url('register_user') ?>">
    ...
    <div class="form-group text-start">
        <h6 class="form-label fw-bold">First Name</h6>
        <input type="text" name="first_name" class="form-control mb-0" placeholder="First Name" required>
    </div>
    <div class="form-group text-start">
        <h6 class="form-label fw-bold">Last Name</h6>
        <input type="text" name="last_name" class="form-control mb-0" placeholder="Last Name" required>
    </div>
    <div class="form-group text-start">
    ...
    <div class="form-group text-start">
        <h6 class="form-label fw-bold">Phone Number</h6>
        <input type="text" name="phone_number" class="form-control mb-0" placeholder="Phone Number">
    </div>
    <div class="form-group text-start">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="form-check d-inline-block m-0">
            ...
            <h6 class="form-check-label fw-500 font-size-14">I accept <a href="#" class="fw-light ms-1">Terms and Conditions</a></h6>
        </div>
    </div>
    <button type="submit" class="btn btn-primary mt-4 fw-semibold text-uppercase w-100">Sign Up</button>
    <h6 class="mt-5">Already Have An Account? <a href="/">Login</a></h6>
</form>
...
<script>
    ...
    <?php if (session()->getFlashdata('error')): ?>
        showPopup('errorPopup', '<?= session()->getFlashdata('error'); ?>');
    <?php endif; ?>

    // Show success popup if there's a success message
    <?php if (session()->getFlashdata('success')): ?>
        showPopup('successPopup', '<?= session()->getFlashdata('success'); ?>');
    <?php endif; ?>
</script>
            </div>
         </div>
